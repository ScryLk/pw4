...
export default function ImoveisViewTable() {
  ...
  return(
    <div>
      <Table>
        <TableCaption>Lista de imóveis disponíveis</TableCaption>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="w-[150px] text-center">Detalhes</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
              ...
              <TableRow key={imovel.id}>
                ...
                <TableCell>
                  <div className="flex justify-center">
                    <DialogDetails imovel={imovel}>
                      <Button size="icon" variant="default" className="w-7 h-7 bg-blue-500 hover:bg-blue-600 rounded-lg cursor-pointer">
